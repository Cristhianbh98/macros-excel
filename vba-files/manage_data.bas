...
sub dataw1()
  ...
  Call actions.updateChartData(destination, "Chart 1")
End Sub
...
sub dataw2()
  ...
  Call actions.updateChartData(destination, "Chart 2")
End Sub
...
sub dataw3()
  ...
  Call actions.updateChartData(destination, "Chart 3")
End Sub
...
sub dataw4()
  ...
  Call actions.updateChartData(destination, "Chart 4")
End Sub
